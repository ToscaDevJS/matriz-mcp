...
- [ ] 2.1 RED: Write `internal/doctor/doctor_test.go` covering codec probe, config probe, and project integrity probe
- [ ] 2.2 GREEN: Implement `internal/doctor/` (`doctor.go`, `probes_codecs.go`, `probes_config.go`, `probes_project.go`, `probes_mcp.go`)
- [ ] 2.3 REFACTOR: Verify masking of API keys and zero network cost
